...
export default function ConstructionsList() {
	...
	return (
		<div className='page-container'>
			...
			<CreateNewExtraSupplies openDialogCreate={openDialogCreate} setOpenDialogCreate={setOpenDialogCreate} />
			...
			<ExtraSuppliesTable rows={rows} onLoadData={dataLoading} isFirstLoad={firstDataLoading} />
